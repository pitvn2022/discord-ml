    ...
    try {
        ...
        client.embed({
            ...
            },
            {
                ...
                value: `You can joining the [[Support server]](${client.config.discord.serverInvite})`,
                inline: false,
            },
            {
            ...
            {
                name: "🤝┆Come here for GenshinStats?",
                value: 'Try \`/genshinstats\` for help or invite [HERE](https://discord.com/api/oauth2/authorize?client_id=1152074810726289429&permissions=2048&scope=bot)',
                inline: false,
            },
            ],
            components: [row], 
